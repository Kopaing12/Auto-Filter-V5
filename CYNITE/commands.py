...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/DEMIGOD_TECH'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/DEMIGOD_TECH_SUPPORT')
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ', url="https://youtube.com/@demigod-tech")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
